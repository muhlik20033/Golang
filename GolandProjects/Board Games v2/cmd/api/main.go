...
import (
	...
	"muhlik20033.bgv2.net/internal/jsonlog"
	"muhlik20033.bgv2.net/internal/mailer"
	"os"
	"strings"
	"sync"
	"time"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "1f0872c6ae5083", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "3fe6d91ef5a2dd", "SMTP password")
